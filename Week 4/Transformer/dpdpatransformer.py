...
# CONFIG
# ----------------------------
PDF_DIR = "pdf_data"          # folder containing your PDF(s)
...
def load_models():
    ...
    # Your environment supports 'text-generation' but not 'text2text-generation'.
    # Use a small instruction/chat model to reduce looping.
    llm = pipeline(
